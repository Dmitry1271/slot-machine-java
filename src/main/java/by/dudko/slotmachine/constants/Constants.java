...
public final class Constants {
    ...
    public static final String[][] SLOT_RINGS = new String[][]{
            {"@", "A", "10", "9", "9", "J", "10", "9", "9", "9", "K", "9", "9", "A", "A", "9", "K", "9", "Q", "J"},
    ...
    //mySQL data
    public static final String URL_DB = "jdbc:mysql://localhost:3306/clients_data";
