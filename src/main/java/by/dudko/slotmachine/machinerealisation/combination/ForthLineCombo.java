 ...
 */
public class ForthLineCombo implements Combo {
    @Override
    public String wonElement(SlotRings slotRings) {
        if (Checking.isEqual(slotRings.getVisiblePartRings()[0][0], slotRings.getVisiblePartRings()[1][1], slotRings.getVisiblePartRings()[2][2])) {
